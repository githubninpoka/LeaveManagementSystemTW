...
{
    // not implemented a service here.
    // the other LeaveType was slightly more complex
    // trainer decides against a service here because of training overhead

    private readonly LeaveManagementSystemDbContext _context;

    public PeriodsController(LeaveManagementSystemDbContext context)
    {
        _context = context;
    }
